...
const article = {
  id: '1',
  title: 'JavaScript News asddaasdadqw wqewq ewqe',
  subtitle: 'Something new in JS for 2022?',
  views: 103,
  createdAt: '22.01.2023',
  type: ['IT', 'SCIENCE', 'ECONOMIC'],
  user: {
    id: '1',
...
ListSmall.args = {
  articles: new Array(9).fill(null).map((_, index) => ({
    ...article,
    id: String(index),
  })),
...
ListBig.args = {
  articles: new Array(3).fill(null).map((_, index) => ({
    ...article,
    id: String(index),
  })),
